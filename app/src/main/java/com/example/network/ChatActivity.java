...
import com.example.network.message.Message;
import com.example.network.message.MessagesAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(String chatId, String message, String date){
        ...
        FirebaseDatabase.getInstance().getReference().child("ChatsId").child(chatId).child("messages").push().setValue(messageInfo);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.sendMessageBtn.setOnClickListener(view -> {
            ...
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("ad.MM.yyyy HH:mm");
    ...
    private void loadMessages(String chatId){
        if (chatId == null) return;
        FirebaseDatabase.getInstance().getReference().child("ChatsId").
